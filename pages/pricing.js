  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Our price is simple: 0.50% of funds raised. Raise funds in crypto, organize, and distribute tokens - all in one place." key="title" />
      </Head>
